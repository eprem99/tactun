...
?><!DOCTYPE html>
    ...
    $search = tactun_option( 'header_search', false);
    $login = tactun_option( 'header_login', false);
    $demo = tactun_option( 'header_request', false); 
    $demolink = tactun_option( 'header_request_link', false); 
    $header = get_post_meta(get_the_ID(), 'transparent_header', true);
...
<body id="scrollpage">
    <header id="masthead" class="header <?php if($header == true){ echo 'transparent'; }?>">
        <div id="content-fulid" class="container-fluid">
            <div class="row">
                <div id="logo" class="col-lg-2 col-md-3 col-6">
                ...
                <div class="col-lg-7 col-md-7 col-1">
                    <nav id="navigation">
                ...
                <div class="col-lg-3 col-md-2 col-5">
                    <div class="flex align-self-end">
                        <?php if($search == true) { get_search_form( ); } ?>
                        <?php if($login == true) { ?>
                        <div class="login-button">
                            <a href="#">
                                <?php esc_html_e('Log in', 'tactun'); ?> 
                                <span>
